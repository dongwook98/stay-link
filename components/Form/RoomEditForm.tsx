...
import { deleteImagesFromCloudinary } from '@/app/rooms/(form)/register/image/_actions/deleteImagesFromCloudinary'
  ...
  return (
    <form
      ...
      onSubmit={handleSubmit(async (res) => {
        console.log('🚀 ~ onSubmit={handleSubmit ~ res:', res)
        try {
